		...
		<tr height="15">
			<td class="text8b" height="35">
		          	<div align="center" valign="center">                                                
		           		<bean:define id="operationKey" name="<%=RequestScopeConstants.REQUEST_ERROROPERATION_TEXT%>" type="java.lang.String"/>
		           		<bean:write name="operationKey"/>.<br><br> 
		           		<font class="textBlue"><html:link page="/login/changePassword-popup.jsp"><bean:message key="text.password.backToChangePassword" bundle="login"/></html:link></font>                           		              	
		           	</div>
		           </td>
		      </tr>
		 </table>
