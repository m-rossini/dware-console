...
<logic:notEmpty name="requestInfo" property="consequenceCounters">
			  	<tr valign="top">
                	<td height="15">
                		<div align="center">
                    	<table width="95%" align="center" class="table" cellpadding="0" cellspacing="0">
					   	<tr>
                        	<td height="25" colspan="3" class="table-column-title"><bean:message key="text.consequences" bundle="requests"/></div></td>
                      	</tr>
					  	<tr height="20" class="textBlue">
                        	<td width="20%"><div align="center"><bean:message key="text.consequenceCode" bundle="requests"/></div></td>
                        	<td width="60%"><div align="center"><bean:message key="text.consequenceName" bundle="requests"/></div></td>
                        	<td width="20%"><bean:message key="text.consequenceCount" bundle="requests"/></td>
                      	</tr>

    <bean:define id="consequenceCounters" name="requestInfo" property="consequenceCounters"/>
	<% int consequenceCounter = 0; String tdClass="";%>
	<c:forEach items="${consequenceCounters}" var="consequences">
	
					  	<tr height="15" class="text8">					  	    
					  	
		<% 
			   if (consequenceCounter%2 == 0) { 
		...
		%>	
                        	...
                        	<td <%=tdClass%>><div align="center"><c:out value="${consequences.ruleCode}"/></div></td>
                      	    <td <%=tdClass%>><div align="left">&nbsp;&nbsp;&nbsp;<c:out value="${consequences.ruleName}"/></div></td>
                      	    <td <%=tdClass%>><div align="left">&nbsp;&nbsp;&nbsp;<c:out value="${consequences.count}"/></div></td>
                      	</tr>
...
<logic:notEmpty name="requestInfo" property="bundleList">
			    <tr valign="top">
                	<td height="15">
                    	...
                    	<table width="95%" align="center" class="table" cellpadding="0" cellspacing="0">
					   	<tr>
                        	<td height="25" colspan="3" class="table-column-title"><bean:message key="text.requestBundleDetailsSubTableTitle" bundle="requests"/></div></td>
                      	</tr>
					  	<tr height="20" class="textBlue">
                        	<td width="20%"><div align="center"><bean:message key="text.processedDateTableColumn" bundle="requests"/></div></td>
                        	<td width="60%"><div align="left">&nbsp;&nbsp;&nbsp;<bean:message key="text.requestLabelTableColumn" bundle="requests"/></div></td>
                        	<td width="20%"></td>
                      	</tr>
